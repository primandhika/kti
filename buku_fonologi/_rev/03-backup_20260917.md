...
1. Mengklasifikasikan bunyi vokal bahasa Indonesia berdasarkan posisi lidah (tinggi, tengah, rendah).
2. Mengklasifikasikan bunyi konsonan bahasa Indonesia berdasarkan tempat artikulasi.
3. Membedakan bunyi segmental dan suprasegmental serta memberikan contoh masing-masing.
4. Menjelaskan bagaimana variasi bunyi bahasa dapat dipengaruhi oleh faktor geografis, sosial, dan budaya.
...
Vokal adalah bunyi yang dihasilkan tanpa hambatan signifikan dalam aliran udara di rongga mulut (Ladefoged & Johnson, 2011). Dalam bahasa Indonesia, vokal diklasifikasikan berdasarkan posisi lidah ketika bunyi dihasilkan (Chaer, 2009). Ada tiga jenis vokal utama, yaitu vokal tinggi, vokal tengah, dan vokal rendah.
...
Ucapkan vokal /i/, /a/, dan /u/ secara berurutan. Perhatikan bagaimana posisi lidah berubah: pada /i/ lidah naik ke depan, pada /a/ lidah turun ke posisi rendah, dan pada /u/ lidah naik ke belakang. Perbedaan posisi lidah inilah yang menghasilkan kualitas bunyi vokal yang berbeda.

## 3.2 Klasifikasi Bunyi Konsonan
Konsonan berbeda dari vokal karena dihasilkan dengan hambatan yang lebih besar dalam aliran udara di sepanjang saluran vokal (Muslich, 2013). Dalam bahasa Indonesia, konsonan diklasifikasikan berdasarkan tempat artikulasi, yaitu bagian alat ucap yang terlibat dalam produksi bunyi.
...
[Bagan konsonan bahasa Indonesia disusun dalam format tabel dua dimensi: baris menunjukkan cara artikulasi (plosif, nasal, frikatif, lateral, getar, semivokal) dan kolom menunjukkan tempat artikulasi (bilabial, labiodental, alveolar, palatal, velar, glotal). Setiap sel berisi fonem yang sesuai.]

Gambar 3.2 Bagan Konsonan Bahasa Indonesia

## 3.3 Bunyi Segmental dan Suprasegmental
Selain vokal dan konsonan yang dapat dipisahkan menjadi unit-unit kecil yang disebut fonem (ini disebut **bunyi segmental**), ada juga **bunyi suprasegmental** yang melampaui batas fonem individu (Crystal, 2008). Bunyi suprasegmental mencakup elemen-elemen seperti:
...
## 3.4 Bunyi Bahasa dan Variasinya
...
Bab ini membahas pengelompokan bunyi bahasa berdasarkan cara dan tempat produksinya. Bunyi vokal diklasifikasikan menurut posisi lidah: vokal tinggi (/i/, /u/), tengah (/e/, /o/), dan rendah (/a/). Bahasa Indonesia juga mengenal diftong, yaitu gabungan dua vokal dalam satu suku kata.

Bunyi konsonan diklasifikasikan menurut tempat artikulasi: bilabial (kedua bibir), labiodental (bibir bawah dan gigi atas), laminoalveolar (ujung lidah dan gusi), dan dorsovelar (belakang lidah dan langit-langit lunak). Selain bunyi segmental (vokal dan konsonan yang dapat dipisahkan menjadi fonem), terdapat pula bunyi suprasegmental yang melampaui batas fonem individual, seperti tekanan, nada, dan jeda.

Bunyi bahasa tidak bersifat statis. Variasi dalam cara bunyi dihasilkan dan digunakan dipengaruhi oleh faktor geografis, sosial, dan budaya. Variasi ini merupakan bagian dari kekayaan linguistik bahasa Indonesia.
...
- **Vokal**: bunyi bahasa yang dihasilkan tanpa hambatan berarti dalam aliran udara di rongga mulut.
- **Konsonan**: bunyi bahasa yang dihasilkan dengan hambatan pada aliran udara di sepanjang saluran vokal.
- **Vokal tinggi**: vokal yang dihasilkan dengan posisi lidah yang tinggi, misalnya /i/ dan /u/.
- **Vokal tengah**: vokal dengan posisi lidah tidak terlalu tinggi atau rendah, misalnya /e/ dan /o/.
- **Vokal rendah**: vokal yang dihasilkan dengan posisi lidah yang rendah, misalnya /a/.
- **Diftong**: gabungan dua vokal dalam satu suku kata, misalnya /ai/ pada "santai" dan /au/ pada "kerbau".
- **Tempat artikulasi**: lokasi di saluran vokal tempat hambatan terjadi saat memproduksi konsonan.
- **Bilabial**: tempat artikulasi yang melibatkan kedua bibir (misalnya /p/, /b/, /m/).
- **Labiodental**: tempat artikulasi yang melibatkan bibir bawah dan gigi atas (misalnya /f/).
- **Laminoalveolar**: tempat artikulasi yang melibatkan ujung lidah dan gusi di belakang gigi atas (misalnya /t/, /d/).
- **Dorsovelar**: tempat artikulasi yang melibatkan bagian belakang lidah dan langit-langit lunak (misalnya /k/, /g/).
- **Bunyi segmental**: bunyi bahasa yang dapat dipisahkan menjadi unit fonem individual (vokal dan konsonan).
- **Bunyi suprasegmental**: unsur bunyi yang melampaui batas fonem individual, seperti tekanan, nada, dan jeda.
