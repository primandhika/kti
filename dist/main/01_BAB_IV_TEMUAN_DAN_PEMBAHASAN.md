...
Analisis kebutuhan belajar dilakukan melalui wawancara dengan dosen pengampu mata kuliah Keterampilan Berbicara dan studi literatur terhadap kurikulum program studi. Hasil analisis menunjukkan bahwa mahasiswa membutuhkan peningkatan pada beberapa aspek keterampilan berbicara, terutama dalam hal pengorganisasian ide, penyampaian argumen secara jelas, serta penggunaan strategi komunikasi yang efektif. Selain itu, ditemukan kebutuhan akan penguatan kemampuan metakognitif yang mendukung proses berpikir dan refleksi selama berbicara.

Dosen pengampu menyampaikan bahwa selama ini metode pembelajaran keterampilan berbicara masih didominasi oleh praktik langsung tanpa panduan refleksi yang memadai. Mahasiswa cenderung langsung menyampaikan materi tanpa terlebih dahulu merencanakan struktur pembicaraan atau mengevaluasi kinerja mereka secara mandiri.

#### b. Kemampuan Awal

Data kemampuan awal diperoleh melalui observasi di kelas dan wawancara informal dengan mahasiswa serta dosen. Hasil observasi menunjukkan bahwa tingkat keterampilan berbicara dan kemampuan metakognitif mahasiswa bervariasi. Sebagian besar mahasiswa menunjukkan kesulitan pada lima dimensi kemampuan metakognitif dalam berbicara, yaitu (1) membangun tujuan dan isi pembicaraan (*conceptualisation*), (2) merumuskan penjelasan dan pilihan bahasa (*formulation*), (3) menjaga kejelasan penyampaian (*articulation*), (4) memantau performa saat berbicara (*self-monitoring*), serta (5) mengevaluasi kinerja berbicara setelah selesai (*self-evaluation*).

Kondisi ini mengindikasikan bahwa mahasiswa belum terbiasa menerapkan strategi metakognitif dalam proses berbicara. Temuan ini menjadi dasar bagi pengembangan media yang secara eksplisit mengintegrasikan komponen metakognitif dalam setiap modul pembelajaran.

#### c. Gaya Belajar

Analisis gaya belajar dilakukan melalui angket preferensi belajar sederhana dan observasi perilaku belajar mahasiswa. Hasil analisis mengungkapkan bahwa mahasiswa cenderung memiliki gaya belajar visual dan kinestetik. Mereka menunjukkan preferensi terhadap media pembelajaran berbasis digital yang interaktif dan dapat diakses secara fleksibel. Temuan ini sejalan dengan karakteristik generasi digital yang terbiasa dengan konten singkat, visual, dan mudah diakses melalui perangkat *mobile* (Hug, 2007).

#### d. Hambatan Belajar

Identifikasi hambatan belajar dilakukan melalui wawancara dengan mahasiswa dan dosen serta observasi kelas. Beberapa hambatan utama yang teridentifikasi meliputi: (1) kurangnya kesempatan praktik berbicara yang bermakna dalam perkuliahan, (2) keterbatasan media pembelajaran inovatif yang mendukung latihan berbicara secara mandiri, (3) rendahnya keterampilan metakognitif mahasiswa yang menyebabkan mereka kurang mampu merefleksi dan memperbaiki kinerja berbicara, serta (4) kecemasan berbicara (*speaking anxiety*) yang menghambat kepercayaan diri mahasiswa.
...
Ringkasan hasil analisis karakteristik mahasiswa disajikan pada Tabel 4.1.

**Tabel 4.1** Ringkasan Hasil Analisis Karakteristik Mahasiswa
...
### 2. *State Objectives* (Penetapan Tujuan Pembelajaran)
...
Tujuan ini menjadi acuan dalam pemilihan metode, pengembangan materi, serta perancangan instrumen evaluasi pada tahap selanjutnya.

### 3. *Select Methods, Media, and Materials* (Pemilihan Metode, Media, dan Materi)

Pemilihan metode, media, dan materi dilakukan berdasarkan hasil analisis karakteristik mahasiswa dan tujuan pembelajaran yang telah ditetapkan.

#### a. Metode Pembelajaran

Metode yang dipilih adalah pengembangan media pembelajaran berbasis web dengan pendekatan *microlearning* yang dipadukan dengan teknik Feynman. Pendekatan *microlearning* memungkinkan penyajian materi dalam unit-unit kecil yang terfokus dan mudah dicerna, sesuai dengan prinsip *limited capacity* dalam *Cognitive Theory of Multimedia Learning* (CTML) oleh Mayer (2014). Teknik Feynman diintegrasikan untuk mendorong mahasiswa menjelaskan kembali konsep menggunakan bahasa mereka sendiri, sehingga memperkuat pemahaman sekaligus mengasah keterampilan metakognitif dan berbicara.

#### b. Media Pembelajaran

Media dirancang dalam bentuk platform web *microlearning* yang dapat diakses melalui perangkat komputer maupun perangkat *mobile*. Komponen utama media terdiri dari: (1) modul singkat yang menyajikan topik-topik linguistik dalam format *bite-sized*; (2) video penjelasan yang memberikan contoh penerapan teknik Feynman; (3) latihan berbicara yang memfasilitasi mahasiswa untuk menerapkan teknik Feynman secara langsung; serta (4) fitur interaktif termasuk kuis evaluasi, perekaman, dan umpan balik semi-otomatis.
...
### 4. *Utilize Media and Materials* (Pemanfaatan Media dan Materi)

Pada tahap ini, media dan materi yang telah dikembangkan diimplementasikan dalam proses perkuliahan. Pemanfaatan media dirancang melalui tiga tahapan utama.

#### a. Persiapan

Sebelum penggunaan media, mahasiswa diberikan panduan penggunaan yang mencakup cara mengakses platform web *microlearning*, alur pembelajaran dalam media, serta cara mengunggah latihan berbicara. Sesi orientasi singkat juga dilakukan untuk memastikan mahasiswa memahami fitur-fitur yang tersedia.

#### b. Pelaksanaan

Mahasiswa mengakses web *microlearning* secara bertahap sesuai jadwal perkuliahan. Proses pembelajaran mengikuti alur berikut: (1) mempelajari materi melalui modul singkat dan video penjelasan; (2) menyelesaikan latihan berbicara setelah setiap modul, berupa penjelasan ulang konsep materi menggunakan teknik Feynman; (3) merekam tugas berbicara dan mengunggahnya ke platform web; serta (4) menerima umpan balik dan melakukan refleksi.

#### c. Asesmen dan Umpan Balik

Asesmen dilakukan melalui dua jalur. Pertama, asesmen otomatis untuk bagian evaluasi konsep melalui kuis interaktif di dalam media. Kedua, asesmen autentik untuk penilaian keterampilan berbicara yang dilakukan oleh dosen melalui panel admin web menggunakan rubrik yang telah dikembangkan. Umpan balik diberikan melalui fitur komentar pada rekaman tugas berbicara mahasiswa.

### 5. *Require Learner Participation* (Partisipasi Mahasiswa)

Prinsip *Require Learner Participation* dalam model ASSURE menekankan pentingnya keterlibatan aktif mahasiswa dalam proses pembelajaran. Dalam penelitian ini, partisipasi mahasiswa diwujudkan melalui beberapa aktivitas berikut:

1. **Memahami dan merangkum konsep:** Mahasiswa mempelajari materi melalui modul singkat dan video, kemudian membuat ringkasan dengan bahasa mereka sendiri sebagai langkah awal teknik Feynman.
2. **Menjelaskan ulang secara lisan:** Mahasiswa merekam penjelasan mereka terhadap konsep yang telah dipelajari, lalu mengunggah rekaman tersebut ke platform web.
...
Evaluasi dilakukan secara formatif dan sumatif untuk mengukur efektivitas media pembelajaran dan menjadi dasar perbaikan produk.

**Evaluasi formatif** dilaksanakan secara terintegrasi selama proses pengembangan dan implementasi, meliputi: (1) validasi oleh ahli materi dan ahli media; (2) uji coba terbatas tahap pertama (*small group*) pada 6 mahasiswa; serta (3) uji coba lebih luas pada 10 mahasiswa sebagai simulasi penggunaan yang lebih utuh sebelum uji lapangan. Hasil evaluasi formatif digunakan untuk merevisi dan menyempurnakan produk sebelum diuji pada skala yang lebih besar.

**Evaluasi sumatif** dilaksanakan melalui uji lapangan (*field test*) dengan desain kuasi-eksperimen yang melibatkan kelompok eksperimen dan kelompok kontrol. Evaluasi ini mencakup analisis hasil *pretest* dan *posttest* keterampilan berbicara, angket kemampuan metakognitif, wawancara mendalam, serta observasi aktivitas mahasiswa. Hasil evaluasi sumatif menjadi bukti empiris efektivitas media yang dikembangkan.

### 7. Deskripsi Produk Final

Produk yang dihasilkan dalam penelitian ini adalah media web *microlearning* berbasis teknik Feynman yang dapat diakses melalui peramban web pada perangkat komputer maupun *mobile*. Media ini terdiri dari beberapa komponen utama yang dirancang untuk mendukung pengembangan keterampilan berbicara dan kemampuan metakognitif mahasiswa.

Berikut deskripsi komponen produk final beserta tampilannya.

**a. Halaman Login dan Registrasi**

Halaman login menyediakan akses bagi mahasiswa yang telah terdaftar untuk masuk ke dalam platform. Fitur registrasi memungkinkan mahasiswa baru untuk membuat akun dengan mengisi data diri yang diperlukan.
...
Dashboard utama menampilkan ringkasan progres belajar mahasiswa, daftar modul yang tersedia, serta notifikasi terkait tugas dan umpan balik. Desain dashboard mengutamakan kesederhanaan navigasi agar mahasiswa dapat langsung mengakses modul yang dibutuhkan.

![](../img/gambar_4_02_dashboard_utama.png)

Gambar 4.2 Tampilan Dashboard Utama
...
Video pembelajaran menyajikan penjelasan materi dengan contoh penerapan teknik Feynman. Video dirancang dengan memperhatikan prinsip *Multimedia Principle* dan *Contiguity Principle* dalam CTML (Mayer, 2014), yaitu menggabungkan narasi verbal dan elemen visual secara berdekatan untuk meminimalkan beban kognitif.

![](../img/gambar_4_04_halaman_video_pembelajaran.png)
...
![](../img/gambar_4_05_aktivitas_teknik_feynman.png)
...
![](../img/gambar_4_06_fitur_perekaman_berbicara.png)
...
![](../img/gambar_4_07_fitur_refleksi_evaluasi_diri.png)
...
![](../img/gambar_4_08_fitur_umpan_balik_kuis.png)
...
Panel admin memungkinkan dosen untuk mengelola modul, memantau progres mahasiswa, menilai rekaman tugas berbicara menggunakan rubrik yang telah disediakan, serta memberikan umpan balik individual.

![](../img/gambar_4_10_panel_admin_dosen.png)

Gambar 4.10 Tampilan Panel Admin/Dosen

Secara keseluruhan, produk final yang dihasilkan merupakan media web *microlearning* yang mengintegrasikan prinsip-prinsip CTML, pendekatan *microlearning*, dan teknik Feynman dalam satu platform pembelajaran yang utuh. Desain media mempertimbangkan hasil analisis karakteristik mahasiswa dan ditujukan untuk mencapai tujuan pembelajaran yang telah ditetapkan pada tahap *State Objectives*.
...
Hasil validasi dianalisis melalui persentase kelayakan dan koefisien Aiken's V. Karena setiap instrumen dinilai oleh tiga validator, nilai Aiken's V pada tahap ini dapat dibaca sebagai derajat kesepakatan antarvalidator terhadap relevansi butir yang dinilai. Meskipun demikian, angka kuantitatif tetap tidak dibaca secara terpisah, tetapi dipertimbangkan bersama catatan, saran, dan penilaian kualitatif dari para validator. Dengan cara ini, kelayakan produk dapat dipahami secara lebih utuh sebelum media masuk ke tahap uji coba.
...
|---|---|---:|---:|---:|---:|---:|---|
| 1 | Kelayakan Isi Materi | 6 | 69 | 72 | 95,83 | 0,944 | Sangat Valid |
| 2 | Desain Pembelajaran *Microlearning* | 6 | 71 | 72 | 98,61 | 0,981 | Sangat Valid |
| 3 | Kesesuaian dengan Teknik Feynman | 5 | 59 | 60 | 98,33 | 0,978 | Sangat Valid |
| 4 | Pengembangan Kemampuan Metakognitif | 5 | 58 | 60 | 96,67 | 0,956 | Sangat Valid |
| 5 | Keterampilan Berbicara | 5 | 58 | 60 | 96,67 | 0,956 | Sangat Valid |
...
|---|---|---|
| 1 | Kelayakan isi materi | Pada beberapa bagian yang membahas hubungan keterampilan berbicara dengan keterampilan berbahasa lain, istilah "mendengarkan" disarankan diganti menjadi "menyimak dan memirsa" agar lebih tepat secara keilmuan. |
| 2 | Simpulan validator | Modul ajar web dinilai cukup menarik dan memiliki unsur kebaruan, terutama pada alur pembelajarannya. |
| 3 | Saran pengembangan lanjutan | Istilah teknis perlu disederhanakan agar lebih mudah dipahami mahasiswa, dan kedalaman materi masih dapat diperluas pada beberapa bagian. |

Masukan tersebut kemudian menjadi dasar untuk memperbaiki materi, terutama pada penyempurnaan istilah, penguatan kedalaman isi, dan penegasan hubungan antara materi berbicara, teknik Feynman, dan aktivitas refleksi mahasiswa. Dengan demikian, revisi yang dilakukan tidak mengubah arah utama produk, tetapi memperhalus bagian-bagian yang masih dapat ditingkatkan agar lebih presisi secara akademik.
...
| No | Aspek | Jumlah Butir | Skor Perolehan | Skor Maksimal | Persentase (%) | Aiken's V | Kriteria |
|---|---|---:|---:|---:|---:|---:|---|
| 1 | Bentuk Media | 4 | 47 | 48 | 97,92 | 0,972 | Sangat Valid |
| 2 | Kualitas Media | 3 | 30 | 36 | 83,33 | 0,778 | Sangat Valid |
| 3 | Fungsi Media | 4 | 44 | 48 | 91,67 | 0,889 | Sangat Valid |
| 4 | Aspek *Microlearning* | 4 | 45 | 48 | 93,75 | 0,917 | Sangat Valid |
|  | **Total** | **15** | **166** | **180** | **92,22** | **0,896** | **Sangat Valid** |

Jika dibandingkan dengan validasi materi, hasil validasi media juga menunjukkan gambaran yang positif dan tetap berada pada kategori sangat valid. Media memperoleh skor 166 dari 180 atau setara 92,22%, dengan nilai Aiken's V keseluruhan 0,896. Artinya, secara umum media telah memenuhi syarat untuk digunakan pada tahap berikutnya, meskipun masih ada beberapa bagian teknis yang perlu dirapikan.

Aspek yang memperoleh penilaian paling tinggi adalah bentuk media, yaitu 97,92% dengan nilai Aiken's V 0,972. Hal ini menunjukkan bahwa tampilan antarmuka, navigasi, tata letak, dan tipografi dipandang sudah sangat baik oleh para validator. Dari sisi pengalaman pengguna, temuan ini penting karena media yang baik tidak hanya harus benar secara isi, tetapi juga mudah dipahami dan nyaman digunakan sejak pertama kali diakses.
...
| No | Aspek | Catatan dan Saran |
|---|---|---|
| 1 | Bentuk media | Antarmuka dinilai rapi dan terlihat profesional. Navigasi mudah dipahami, terutama pada dashboard dan modul uji, tetapi hirarki visual masih dapat diperkuat agar fokus pengguna lebih terarah. |
| 2 | Kualitas media | Secara umum media cukup stabil, tetapi pada modul uji masih ditemukan beberapa tombol yang perlu diperbaiki karena berpotensi menimbulkan *bug*. |
| 3 | Fungsi media | Media dipandang mendukung pembelajaran aktif, antara lain melalui kuis, asesmen mandiri, dan fitur uji rekam yang relevan dengan implementasi teknik Feynman. |
| 4 | Aspek *microlearning* | Segmentasi materi dinilai sudah sesuai dengan prinsip *microlearning* dan CTML, serta mendukung pembelajaran mandiri. Namun, fitur navigasi masih dapat diperkaya. |
| 5 | Kelebihan media | UI sudah terstruktur dengan baik, mendukung evaluasi terintegrasi berbasis video, dan memiliki elemen gamifikasi yang berpotensi meningkatkan motivasi belajar mahasiswa. |
| 6 | Kelemahan media | Sistem gamifikasi masih tampak sebagai elemen tambahan dan belum sepenuhnya terintegrasi dengan alur penggunaan media. |
| 7 | Saran pengembangan lanjutan | Instruksi pada modul uji perlu diperjelas agar penilaian lebih valid, dan permainan inovatif yang terkait keterampilan berbicara, suara, serta teknik Feynman dapat diperbanyak. |
...
|---|---|---:|---:|---:|---:|---:|---|---|
| 1 | Ahli materi | 30 | 351 | 360 | 97,50 | 0,967 | Sangat Valid | Layak digunakan dengan revisi terbatas |
| 2 | Ahli media | 15 | 166 | 180 | 92,22 | 0,896 | Sangat Valid | Layak digunakan dengan revisi terbatas |
|  | **Total tertimbang** | **45** | **517** | **540** | **95,74** | **0,943** | **Sangat Valid** | **Produk layak diujicobakan** |

Jika kedua hasil validasi dibaca secara bersamaan, tampak bahwa baik substansi materi maupun kualitas media sama-sama telah berada pada kategori sangat valid. Validasi materi memberikan capaian yang lebih tinggi, sedangkan validasi media masih menyisakan beberapa catatan pada sisi teknis, stabilitas sistem, dan kelancaran interaksi pengguna. Perbedaan ini wajar karena materi dan media diuji melalui fokus yang berbeda.
...
| 5 | Ahli media | Tampilan *mobile* belum responsif secara optimal | Dilakukan penyesuaian CSS agar tampilan lebih responsif pada berbagai ukuran layar. |
| 6 | Penguji seminar kemajuan | Kriteria penilaian perlu lebih rinci dan instruksi modul uji perlu lebih jelas | Subpoin kriteria diperjelas dan instruksi pada modul uji ditambahkan agar lebih operasional. |
| 7 | Penguji seminar kemajuan | Kriteria harus sesuai dengan konstruk penelitian | Dilakukan pemetaan ulang antara kriteria penilaian dengan konstruk keterampilan berbicara dan kemampuan metakognitif. |

Revisi yang dilakukan memperlihatkan bahwa penyempurnaan produk tidak berhenti pada aspek visual semata. Perbaikan justru menyentuh bagian yang lebih esensial, yaitu ketepatan substansi, kejelasan instruksi, kenyamanan penggunaan, dan keselarasan konstruk penilaian. Karena itu, hasil validasi dalam penelitian ini tidak hanya berfungsi sebagai penanda bahwa produk berada pada kategori sangat valid, tetapi juga menjadi pijakan nyata untuk memperbaiki mutu media sebelum digunakan pada tahap uji coba.
...
|---|---|---:|---|
| 1 | Kualitas isi | 87,50 | Sangat baik |
| 2 | Kemudahan penggunaan | 75,00 | Baik |
| 3 | Interaktivitas | 87,50 | Sangat baik |
| 4 | Dampak terhadap keterampilan berbicara | 77,08 | Baik |
| 5 | Dampak terhadap kemampuan metakognitif | 75,00 | Baik |
| 6 | Karakteristik *microlearning* | 76,04 | Baik |
...
| 3 | Ketepatan | 8,83 | 9,83 | 1,00 |
| 4 | Strategi | 9,67 | 10,83 | 1,17 |
...
| No | Aspek | Rerata Persentase (%) | Kategori |
|---|---|---:|---|
| 1 | Tampilan | 100,00 | Sangat baik |
| 2 | Navigasi | 92,50 | Sangat baik |
| 3 | Multimedia | 95,00 | Sangat baik |
| 4 | Interaktivitas | 100,00 | Sangat baik |
| 5 | Materi | 100,00 | Sangat baik |
...
|---|---|---|---|---|---|
| 1 | Uji coba tahap pertama | *microlearning* disukai, materi ringkas, video membantu, fitur interaktif menarik | Penerimaan awal terhadap desain pembelajaran | Enam mahasiswa menyukai format *microlearning*; empat mahasiswa menilai kualitas materi sebagai kekuatan utama | Struktur materi singkat, video, dan latihan interaktif dipertahankan |
| 2 | Uji coba tahap pertama | login tidak lancar, navigasi antarseksi belum mulus, tombol kecil, video berat | Hambatan *usability* awal | Tiga mahasiswa mengeluhkan login; empat mahasiswa menandai navigasi sebagai bagian yang perlu diperbaiki | Autentikasi diperbaiki, navigasi disederhanakan, video di-*embed*, tombol interaktif diperjelas |
...
Uji lapangan dilakukan untuk menilai efektivitas media web *microlearning* berbasis teknik Feynman pada konteks pembelajaran nyata. Sesuai desain kuasi-eksperimen, subjek penelitian terdiri atas 40 mahasiswa pada kelas eksperimen dan 37 mahasiswa pada kelas kontrol, sehingga total partisipan berjumlah 77 mahasiswa. Data kuantitatif pada tahap ini mencakup skor keterampilan berbicara, skor kemampuan metakognitif, dan respons mahasiswa terhadap penggunaan media.
...
|---|---|---:|---:|---:|---|
| 1 | Keterampilan berbicara *pretest* | 40 | 37 | 77 | Digunakan untuk analisis deskriptif, uji prasyarat, uji beda, *N-gain*, dan *effect size* |
| 2 | Keterampilan berbicara *posttest* | 40 | 37 | 77 | Tersedia lengkap sebagai pasangan *pretest-posttest* |
| 3 | Metakognitif *pretest* | 40 | 37 | 77 | Digunakan untuk analisis deskriptif, uji beda berpasangan, dan *N-gain* |
...
|---|---|---|---|
| 1 | Normalitas postes kelompok eksperimen | `p = 0,785` | Tidak menolak normalitas |
| 2 | Normalitas distribusi lain (pretes eksperimen, pretes kontrol, postes kontrol, gain eksperimen, gain kontrol) | `p < 0,05` pada beberapa distribusi | Sebagian distribusi menyimpang dari normalitas |
| 3 | Homogenitas varians pretes | `p = 0,0025` | Varians awal antarkelompok berbeda |
...
|---|---|---|
| *Paired sample t-test* kelompok eksperimen | mean gain = `11,86`; 95% CI `[9,72; 14,01]`; `p < 0,001`; Cohen's `dz = 1,768` | Terdapat peningkatan yang sangat kuat dalam kelompok eksperimen |
...
|---|---:|---:|---:|---|
| Seluruh data | 77 | 0,151 | 0,043 | Hubungan sangat lemah |
...
|---|---|---|---|---|
| 1 | D01, kelas eksperimen | Keterlibatan mahasiswa | 85% mahasiswa aktif, membaca materi, menonton video, progres terganggu login dan perangkat ganda | Keterlibatan tinggi, tetapi terhambat masalah akses |
| 2 | D01, kelas eksperimen | Efektivitas media | akses rutin, ada kebaruan materi, latihan dan poin mendorong partisipasi, fase akhir mulai jenuh | Media membantu latihan berbicara, tetapi beban aktivitas perlu diatur |
| 3 | D01, kelas eksperimen | Kemampuan metakognitif | mahasiswa mulai menyiapkan isi sebelum berbicara, memahami perlunya perencanaan | Media memperkuat *conceptualisation* dalam proses berbicara |
| 4 | D01, kelas eksperimen | Tantangan dan saran | adaptasi fitur penilaian digital, beban respons dosen, usulan penilaian otomatis dan mode *offline* | Efisiensi asesmen dan dukungan teknis menjadi kebutuhan pengembangan |
| 5 | D02, kelas kontrol | Keterlibatan mahasiswa | penggunaan media tidak diwajibkan, hanya sebagian kecil mencoba untuk persiapan tes | Keterpakaian media di kelas kontrol bersifat terbatas dan sukarela |
...
Pandangan dosen kelas kontrol juga menunjukkan arah yang serupa, meskipun dalam intensitas yang lebih terbatas. Dari sekitar 4 sampai 5 mahasiswa yang mencoba media, satu mahasiswa dinilai menunjukkan progres yang cukup baik dan tampak lebih siap ketika tes berbicara. Kutipan dosen kelas kontrol menegaskan hal ini, yaitu *"Dari sekitar 4-5 yang mencoba, satu mahasiswa menunjukkan progres yang cukup baik, yaitu jadi lebih siap ketika tes."* Temuan ini mengisyaratkan bahwa media berpotensi membantu performa berbicara, tetapi dampaknya pada kelas kontrol belum dapat terbaca kuat karena penggunaan media tidak berlangsung secara sistematis pada seluruh peserta.

Pada aspek kemampuan metakognitif, dosen kelas eksperimen menilai bahwa beberapa mahasiswa mulai menunjukkan perubahan pada tahap *conceptualisation* sebelum berbicara. Mahasiswa tidak lagi sepenuhnya berbicara secara spontan, tetapi mulai menyiapkan isi, memperhatikan hasil latihan, dan memahami bahwa performa berbicara memerlukan persiapan. Dosen menyatakan, *"Mereka yang mencoba perlahan mulai mengerti pola, setiap bicara mesti ada perencanaan dulu."* Temuan ini menunjukkan adanya penguatan kesadaran metakognitif, terutama pada tahap *conceptualisation* yang kemudian menopang proses berbicara berikutnya. Secara substantif, hasil ini selaras dengan Paterson (2022) dan Sabnani serta Goh (2022) yang menekankan bahwa performa berbicara yang lebih baik ditopang oleh kebiasaan reflektif saat menyiapkan, menyampaikan, memantau, dan menilai ulang ujaran secara sadar.

Pada kelas kontrol, dosen juga melihat adanya peningkatan kesiapan pada sebagian mahasiswa yang mencoba media, terutama karena mereka menyadari bahwa media menuntut perhatian pada lebih banyak aspek penilaian. Meski begitu, kebebasan sumber belajar di kelas kontrol menyebabkan persiapan mahasiswa menjadi kurang seragam. Bahkan, dosen mengamati bahwa sebagian mahasiswa cenderung mengandalkan hasil *generate* AI ketika menghadapi tes berbicara. Dengan demikian, data dosen memperlihatkan bahwa media dapat membantu munculnya kesadaran persiapan dan refleksi, tetapi dampaknya lebih kuat ketika penggunaannya terintegrasi secara konsisten dalam pembelajaran.

Dari sisi tantangan penerapan, kedua dosen menyoroti bahwa hambatan penggunaan media tidak hanya bersifat teknis pada mahasiswa, tetapi juga menyentuh alur kerja dosen. Pada kelas eksperimen, kendala yang muncul meliputi lupa kata sandi, penggunaan satu perangkat berdua, kebutuhan mencari tempat yang tenang untuk merekam, adaptasi terhadap fitur penilaian digital, dan bertambahnya kebutuhan penjelasan karena adanya fitur tanya jawab. Sementara itu, pada kelas kontrol tantangan utama terletak pada ketidakseragaman sumber belajar mahasiswa, masalah kebahasaan dan kesantunan berbahasa, serta akses fitur pemeriksaan dari ponsel yang masih terasa kurang praktis. Temuan ini menegaskan bahwa implementasi media pembelajaran digital perlu ditinjau tidak hanya dari sisi mahasiswa, tetapi juga dari sisi beban kerja dan kenyamanan operasional dosen.

Saran pengembangan dari kedua dosen memperlihatkan arah perbaikan yang cukup jelas. Dosen kelas eksperimen mengusulkan adanya penilaian otomatis berbantuan AI dan mode *offline* agar beban penggunaan media lebih ringan serta tetap dapat diakses dalam kondisi teknis yang terbatas. Dosen kelas kontrol menilai fitur pemeriksaan sebenarnya sudah cukup rinci, tetapi akses dari ponsel masih perlu disederhanakan dan proses pengisian nilai perlu dilengkapi dengan fitur simpan otomatis. Dengan demikian, respons dosen pada dasarnya mendukung penggunaan media, tetapi sekaligus menekankan pentingnya penguatan *usability*, fleksibilitas akses, dan efisiensi sistem penilaian.

Berdasarkan keseluruhan hasil wawancara, dapat disimpulkan bahwa dosen memandang media web *microlearning* berbasis teknik Feynman sebagai sarana yang potensial untuk mendukung keterlibatan mahasiswa, memperbaiki kesiapan berbicara, dan memunculkan unsur perencanaan dalam proses belajar. Akan tetapi, efektivitas implementasinya sangat dipengaruhi oleh stabilitas teknis, konsistensi integrasi dalam pembelajaran, kemudahan akses melalui perangkat bergerak, serta beban kerja dosen pada proses penilaian dan umpan balik. Temuan ini penting karena memberikan sudut pandang pelaksana pembelajaran yang melengkapi penilaian mahasiswa terhadap kepraktisan media.

### 2. Respons Mahasiswa dan Perubahan Strategi Belajar

Wawancara mahasiswa memperlihatkan bahwa perubahan yang terjadi tidak hanya tampak pada hasil skor, tetapi juga pada cara mahasiswa memahami proses berbicara mereka sendiri. Beberapa mahasiswa mulai menyadari bahwa berbicara yang baik memerlukan kerangka, bukan sekadar keberanian tampil. Mahasiswa lain menekankan manfaat *playback*, pengulangan rekaman, dan umpan balik sebagai sarana untuk memeriksa kelemahan yang sebelumnya tidak mereka sadari.

Pada dimensi **conceptualisation** dan **formulation**, kecenderungan yang paling sering muncul adalah kebiasaan menyusun poin utama sebelum berbicara dan merumuskan penjelasan secara lebih teratur. Seorang mahasiswa menyatakan bahwa setelah menggunakan media, ia tidak lagi langsung berbicara, tetapi mulai membuat kerangka terlebih dahulu. Temuan ini menunjukkan bahwa teknik Feynman dalam media tidak hanya mendorong penguasaan isi, tetapi juga membentuk kebiasaan menata alur dan pilihan penjelasan sebelum tampil.

Pada dimensi **articulation**, **self-monitoring**, dan **self-evaluation**, beberapa mahasiswa menyebut bahwa mereka mulai peka terhadap tempo, intonasi, jeda, dan urutan penyampaian. Fitur *playback* memberi kesempatan bagi mahasiswa untuk mendengar kembali penjelasan mereka sendiri, lalu membandingkannya dengan contoh atau dengan target performa yang diharapkan. Dalam konteks ini, rekaman tidak hanya menjadi alat dokumentasi tugas, tetapi juga menjadi sarana refleksi performa dan perbaikan penjelasan.

Wawancara mahasiswa juga menunjukkan perubahan pada aspek afektif. Sejumlah mahasiswa merasa lebih tenang dan lebih percaya diri karena dapat berlatih berulang kali sebelum tampil. Mahasiswa lain menilai bahwa durasi *microlearning* yang singkat membuat mereka tidak cepat jenuh dan lebih mudah mengulang materi ketika ada bagian yang belum dipahami. Temuan ini menguatkan bahwa fleksibilitas akses dan singkatnya unit materi bukan hanya memudahkan belajar, tetapi juga membantu menjaga kesiapan psikologis mahasiswa saat berbicara.

Meskipun demikian, perubahan tersebut tidak sepenuhnya merata. Ada mahasiswa yang masih merasa kesulitan menerjemahkan pemahaman konseptual ke dalam praktik berbicara yang runtut. Pola ini penting karena menjelaskan mengapa korelasi skor akhir metakognitif dan keterampilan berbicara tidak muncul kuat secara linear. Dengan kata lain, perkembangan strategi belajar memang tampak, tetapi kedalaman internalisasi pada tiap mahasiswa masih berbeda-beda.

### 3. Temuan Observasi Implementasi Media

Hasil observasi selama implementasi juga mendukung pembacaan di atas. Pada delapan sesi penggunaan media, sekitar 87% mahasiswa menggunakan media sesuai waktu yang ditentukan, 82% menyelesaikan seluruh modul, dan 78% mengakses fitur interaktif secara aktif. Dari sisi penerapan teknik Feynman, sekitar 82% mahasiswa sudah mampu menjelaskan ulang materi dengan bahasa sendiri, meskipun pada konsep yang lebih kompleks sebagian mahasiswa masih memerlukan bimbingan tambahan.

Observasi juga menunjukkan bahwa fitur rekaman, refleksi, dan revisi dipakai secara luas. Seluruh mahasiswa yang diamati menggunakan fitur rekaman dan mengisi lembar refleksi, walaupun kedalaman refleksinya tidak selalu sama. Mahasiswa juga cenderung merespons umpan balik dengan melakukan revisi pada bagian yang dianggap masih lemah. Temuan ini memperkuat bahwa mekanisme kerja media bukan hanya terletak pada penyampaian materi, tetapi pada siklus praktik, refleksi, dan perbaikan yang berulang.
...
Dengan demikian, integrasi temuan mengarah pada satu kesimpulan utama. Media web *microlearning* berbasis teknik Feynman bekerja secara paling kuat ketika tiga unsur hadir secara bersamaan, yaitu materi yang ringkas dan fokus, latihan menjelaskan ulang yang berulang, serta ruang refleksi yang membuat mahasiswa menyadari kualitas performa mereka sendiri. Dari titik inilah peningkatan metakognitif dan keterampilan berbicara dapat dipahami secara lebih masuk akal.
...
Dari sisi desain pembelajaran, hasil pengembangan ini juga sejalan dengan *Cognitive Theory of Multimedia Learning*. Mayer dan Fiorella (2024) serta Noetel et al. (2022) menekankan bahwa pembelajaran multimedia bekerja lebih baik ketika materi disusun ringkas, fokus, dan tidak membebani memori kerja dengan unsur yang tidak relevan. Pola tersebut tampak pada produk yang dikembangkan, khususnya pada segmentasi materi, penggunaan video singkat, latihan rekam, dan fitur refleksi. Dengan kata lain, kekuatan pengembangan produk ini bukan hanya pada keputusan menggunakan media web, tetapi pada cara media itu dirancang agar selaras dengan karakter mahasiswa dan tujuan pembelajaran berbicara.

### 2. Pembahasan Kelayakan Produk

Hasil validasi menunjukkan bahwa produk berada pada kategori sangat valid, baik dari sisi materi maupun media. Capaian ini penting karena menandakan bahwa kualitas produk tidak hanya dinilai dari tampilan luarnya, tetapi juga dari kesesuaian isi, alur pembelajaran, dukungan terhadap teknik Feynman, dan potensi pengembangan metakognitif. Dalam pengembangan media pembelajaran, validitas seperti ini menjadi titik awal yang menentukan, sebab produk yang menarik tetapi tidak presisi secara pedagogis justru berisiko menghasilkan aktivitas yang sibuk tetapi miskin makna belajar.

Catatan para validator juga menunjukkan bahwa kelayakan produk dalam penelitian ini bukan hasil yang datang tanpa revisi. Justru, beberapa bagian yang paling penting, seperti pemecahan materi, kejelasan navigasi, ukuran tombol perekaman, dan responsivitas *mobile*, muncul sebagai hasil penyempurnaan bertahap. Pola ini sejalan dengan Noetel et al. (2022) dan Mayer serta Fiorella (2024) yang menekankan bahwa kualitas media pembelajaran sangat dipengaruhi oleh keselarasan antara desain informasi, kemudahan interaksi, dan tujuan belajar. Dengan demikian, validitas tinggi pada produk ini lebih tepat dibaca sebagai hasil dari proses revisi yang serius, bukan sekadar skor penilaian yang tinggi.

Selain itu, hasil uji coba memperlihatkan bahwa kelayakan akademik dan kelayakan penggunaan bergerak bersama. Produk dinilai layak oleh ahli, kemudian keterterimaannya meningkat setelah revisi dilakukan. Hal ini penting, sebab pada konteks pendidikan tinggi digital, masalah penggunaan sering kali menjadi pembeda antara media yang secara konsep baik dan media yang benar-benar dipakai mahasiswa. Dalam hal ini, temuan penelitian juga bersesuaian dengan Halim et al. (2024) yang menunjukkan bahwa desain digital yang efektif harus memperhatikan pengalaman pengguna, kejelasan alur, dan hambatan implementasi di lapangan.
...
Meskipun hasil penelitian menunjukkan kecenderungan yang positif, beberapa keterbatasan tetap perlu dicatat secara terbuka. Pertama, penelitian dilakukan pada satu program studi dengan dua kelas yang sudah ada, sehingga generalisasi hasil perlu dilakukan secara hati-hati. Desain kuasi-eksperimen memang cukup memadai untuk membandingkan dua kelompok pada konteks nyata, tetapi tetap belum sekuat eksperimen acak dalam mengendalikan seluruh pengaruh luar.

Kedua, implementasi media masih dipengaruhi oleh kondisi teknis, seperti login, kestabilan akses, penggunaan perangkat bersama, kebutuhan tempat tenang untuk merekam, dan kenyamanan akses dosen melalui ponsel. Temuan ini menunjukkan bahwa efektivitas media digital tidak pernah sepenuhnya bergantung pada desain pedagogis saja, tetapi juga pada kesiapan infrastruktur dan pengalaman penggunaan. Hal ini sejalan dengan Handayani dan Fauzi (2023) serta Halim et al. (2024) yang menegaskan bahwa hambatan akses dan *usability* tetap menjadi faktor penting dalam keberhasilan pembelajaran digital di pendidikan tinggi.

Ketiga, tidak semua aspek keterampilan berbicara meningkat secara sama kuat. Aspek kejelasan dan strategi belum menunjukkan keunggulan gain yang setegas pengorganisasian, ketepatan, dan dampak penyampaian. Hal ini mengisyaratkan bahwa sebagian komponen performa berbicara mungkin memerlukan intervensi yang lebih panjang, umpan balik yang lebih detail, atau dukungan latihan sinkron yang lebih intensif.

Keempat, hubungan kuantitatif antara skor metakognitif dan skor keterampilan berbicara cenderung lemah. Karena itu, temuan penelitian ini lebih kuat ketika dibaca sebagai bukti bahwa media membantu membangun proses belajar yang reflektif dan mendukung peningkatan performa, bukan sebagai bukti bahwa kedua konstruk selalu berkorelasi tinggi pada tingkat skor individual.

Kelima, pada konstruk metakognitif rerata skor awal kelompok eksperimen berada di bawah kelompok kontrol. Walaupun pola gain dan *N-gain* tetap menunjukkan peningkatan yang lebih kuat pada kelompok eksperimen, pembacaan hasil pada konstruk ini tetap perlu ditempatkan secara hati-hati dalam konteks skor awal yang tidak sepenuhnya seimbang.

Atas dasar keterbatasan tersebut, penelitian lanjutan dapat diarahkan pada implementasi lintas kelas atau lintas perguruan tinggi, durasi penggunaan yang lebih panjang, penguatan analitik penggunaan media, serta penyempurnaan fitur umpan balik otomatis agar beban dosen berkurang dan kualitas refleksi mahasiswa tetap terjaga.
