...
# We'll replace the entire Slide 3 content to fix everything perfectly
start_str = "Identifikasi Masalah"
...
<h2 style="color:var(--c-gold); font-size:1.1em; margin:0 0 10px 0;"><i class="fa-solid fa-triangle-exclamation"></i> Identifikasi Masalah Utama</h2>
...
<div style="font-size:0.35em; color:var(--c-fg3); text-align:left; border-left:3px solid var(--c-gold); padding-left:10px; line-height:1.2; background: rgba(0,0,0,0.15); padding-top:6px; padding-bottom:6px; border-radius: 0 6px 6px 0;">
  <strong style="color:var(--c-gold); margin-bottom: 2px; display:inline-block;">Berdasarkan Studi Pendahuluan:</strong><br/>
  ...
  3. Primandhika, R. B., Solihati, N., & Zulaiha, S. (2026). AI's Impact on Students' Oral Presentation Skills: Indonesian Lecturers' Pedagogical Responses. <em>Edukasi: Jurnal Pendidikan dan Pengajaran</em>, 13(1), 274-293.
    ...
    with open(INPUT, "w", encoding="utf-8") as f:
        f.write(html)
    print("Slide 3 replaced successfully! Guaranteed safe zone fit.")
else:
