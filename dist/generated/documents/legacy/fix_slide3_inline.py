...
# I will replace the current Slide 3.
...
if start_idx != -1:
    ...
    new_slide = """<section>
<div class="slide-content" style="padding: 0 20px;">
<h2 style="color:var(--c-gold); font-size:1.25em; margin:0 0 5px 0;"><i class="fa-solid fa-triangle-exclamation"></i> Identifikasi Masalah Utama</h2>
...
<div style="font-size:0.55em; color:var(--c-fg3); text-align:left; border-left:3px solid var(--c-gold); padding-left:10px; line-height:1.25; background: rgba(0,0,0,0.15); padding-top:6px; padding-bottom:6px; border-radius: 0 6px 6px 0;">
  ...
  3. Primandhika, R. B., Solihati, N., & Zulaiha, S. (2026). AI's Impact on Students' Oral Presentation Skills: Indonesian Lecturers' Pedagogical Responses. <em>Edukasi</em>, 13(1), 274-293.
    ...
    with open(INPUT, "w", encoding="utf-8") as f:
        f.write(html)
    print("Slide heavily optimized: Icons inline, large font, fits perfectly.")
else:
