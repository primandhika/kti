      ...
      <div class="flex items-center gap-2">
        ...
        <div class="relative">
          ...
          >
            <div class="py-1">
              <button
                @click="$emit('downloadMenu', 'with-image')"
              ...
              >
                ...
                <div class="text-left">
                  <div class="font-medium text-gray-900">Dengan Gambar</div>
                  <div class="text-[10px] text-gray-500">Foto & warna</div>
                </div>
              </button>
              <button
                @click="$emit('downloadMenu', 'without-image')"
              ...
              >
                ...
                <div class="text-left">
                  ...
                  <div class="text-[10px] text-gray-500">Hemat tinta</div>
                </div>
              </button>
            </div>
          </div>
        ...
        <Link
          href="/pengelola/setting?tab=subKategoriToko"
...
defineProps({
  ...
  showDownloadDropdown: { type: Boolean, required: true },
  kategoris: { type: Array, required: true },
  workUnits: { type: Array, required: true },
});

defineEmits(['toggleShowAll', 'toggleDownload', 'downloadMenu', 'update:searchQuery', 'update:filterKategori', 'update:filterWorkUnit']);
</script>
