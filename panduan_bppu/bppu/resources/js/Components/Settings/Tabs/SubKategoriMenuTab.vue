<template>
  <div class="p-6">
    <div class="flex items-center justify-between mb-4">
      <div>
        <h3 class="text-lg font-semibold text-gray-900">Sub Kategori Menu Kantin</h3>
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center gap-2 ml-4">
            ...
            <button
              ...
              :disabled="subKat.jumlah_menu > 0"
              :class="{ 'opacity-50 cursor-not-allowed': subKat.jumlah_menu > 0 }"
              :title="subKat.jumlah_menu > 0 ? 'Tidak dapat menghapus kategori yang masih digunakan' : 'Hapus kategori'"
            >
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
