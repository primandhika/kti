# Panduan Best Practice Operasional

Dokumen ini menjelaskan cara pemakaian yang benar untuk empat area yang paling rawan salah: stok/opname, buku kas, potongan/voucher, serta bagi hasil mitra. Berbeda dengan panduan langkah-per-langkah, di sini fokusnya adalah *mengapa* sebuah alur harus dijalankan dengan cara tertentu, supaya angka di sistem tetap dapat dipercaya dan dapat diaudit.

Semua penjelasan di bawah mengikuti perilaku sistem yang sebenarnya, bukan aturan umum.
